    ...
    public CommandLineRunner initData(RoleRepository roleRepository, UserRepository userRepository, PasswordEncoder passwordEncoder) {
        return args -> {
            ...
            Role userRole = roleRepository.findByRoleName(RoleApp.ROLE_USER)
                    .orElseGet(() -> {
                        Role newUserRole = new Role(RoleApp.ROLE_USER);
                        return roleRepository.save(newUserRole);
                    });

            Role sellerRole = roleRepository.findByRoleName(RoleApp.ROLE_SELLER)
                    .orElseGet(() -> {
                        Role newSellerRole = new Role(RoleApp.ROLE_SELLER);
                        return roleRepository.save(newSellerRole);
                    });

            Role adminRole = roleRepository.findByRoleName(RoleApp.ROLE_ADMIN)
                    .orElseGet(() -> {
                        Role newAdminRole = new Role(RoleApp.ROLE_ADMIN);
